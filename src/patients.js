...
import { Filter, TextInput, ReferenceInput, SelectInput, List, Datagrid, EmailField, TextField, EditButton, Create, Edit, SimpleForm, DisabledInput, DateInput, LongTextInput, ReferenceManyField, DataGrid, DateField } from 'admin-on-rest';
...
const ProfilePhotoField = ({ record = {} }) => <img width="50px" height="50px" src={"https://api-qa.imyourdoc.com/profilepic.php?user_name=" + record.username} />;
